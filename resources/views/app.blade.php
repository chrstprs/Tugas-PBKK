                ...
                <div class="s-header__block">
                    <div class="s-header__logo">
                        <a class="logo" href="index.html">
                            <img src="images/biodata.png" alt="Homepage">
                        </a>
                    </div>
        ...
        <footer class="s-footer">
            <div class="row s-footer__content">
                <div class="column xl-6 lg-6 md-12 s-footer__block s-footer__about">                    
                    <h3>About Christ</h3>
                    <p>
                        Saya adalah mahasiswa semester empat jurusan teknik informatika di Universitas Bengkulu. 
                        Ketertarikan saya pada pemrograman terus berkembang seiring dengan kemajuan studi saya. 
                        Saya terus menjelajahi berbagai bahasa pemrograman dan teknologi terbaru, 
                        dengan tujuan memperdalam pemahaman saya di bidang teknologi informasi. 
                        Komitmen saya terhadap pembelajaran dan inovasi mendorong saya untuk meraih kesuksesan di bidang ini.
                    </p>               
                </div>                
